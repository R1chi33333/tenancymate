...
2. Cite the section for every claim, inline, in exactly this form: [s 18] or [s 13A]. Cite only the bracketed section labels of the provided sections; never cite a section that is merely mentioned inside their text.
...
// Accepts subsection detail like [s 39(2)(a)]; the base section is
// what gets validated and linked.
